 ...
 "cells": [
  {
   "cell_type": "code",
   "execution_count": 1,
   "id": "80c2b331-b908-44ed-ae54-f3b0d3e4663a",
   "metadata": {},
   "outputs": [],
   "source": [
    "import numpy as np\n",
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 2,
   "id": "5b10200c-f780-4998-8844-598f9db03f3f",
   "metadata": {},
   "outputs": [
    {
     "name": "stderr",
     "output_type": "stream",
     "text": [
      "C:\\Users\\HP\\AppData\\Local\\Temp\\ipykernel_2464\\378180666.py:1: DtypeWarning: Columns (3) have mixed types. Specify dtype option on import or set low_memory=False.\n",
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 3,
   "id": "1e5735b8-3c70-4245-a920-1c41a557cb03",
   "metadata": {},
   "outputs": [
    {
     "name": "stdout",
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 4,
   "id": "284f7e99-21e8-4bf2-a0e2-b0701f6c5599",
   "metadata": {},
   "outputs": [
    {
     "data": {
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 5,
   "id": "f0bff698-170d-4236-b23f-66cf6a80133a",
   "metadata": {},
   "outputs": [
    {
     "data": {
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 6,
   "id": "de156bef-dbb0-47ee-ba79-540b5abf3ded",
   "metadata": {},
   "outputs": [
    {
     "data": {
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 7,
   "id": "afd27681-df5c-4cf1-8682-49516a5be954",
   "metadata": {},
   "outputs": [
    {
     "data": {
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 8,
   "id": "6f4cdf60-c3b8-489e-9262-f17d59a9a78b",
   "metadata": {},
   "outputs": [
    {
     "data": {
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 8,
   "id": "de33a807-18b1-4005-9c5a-84b8d39c1f72",
   "metadata": {},
   "outputs": [
    {
     "data": {
  ...
  {
   "cell_type": "markdown",
   "id": "f1c02892-9c9e-42aa-af5d-118980ed6d0c",
   "metadata": {},
   "source": [
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 10,
   "id": "b515a740-f49f-41a6-bcab-70eb43812f0e",
   "metadata": {},
   "outputs": [
    {
     "data": {
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 12,
   "id": "bf233e06-a8d9-42eb-9a8e-3d7e9e823c49",
   "metadata": {},
   "outputs": [
    {
     "data": {
   ...
   "source": [
    "num_rating_df = book_rating.groupby('Book-Title')['Book-Rating'].count().reset_index()\n",
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 11,
   "id": "3654a667-a713-402f-a468-f3ad8b05fc74",
   "metadata": {},
   "outputs": [
    {
     "data": {
   ...
   "source": [
    "avg_rating_df = book_rating.groupby('Book-Title')['Book-Rating'].mean().reset_index()\n",
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 13,
   "id": "b1b09aa7-1f57-4de6-be61-e84a582eac67",
   "metadata": {},
   "outputs": [
    {
     "data": {
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 14,
   "id": "4be6cd1f-fa36-4039-8680-68e040dc3918",
   "metadata": {},
   "outputs": [],
   "source": [
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 15,
   "id": "04c13627-8b27-4a90-a422-f8ca13d4f28b",
   "metadata": {},
   "outputs": [
    {
     "data": {
      ...
      "text/plain": [
       ...
       "16   The Hobbit : The Enchanting Prelude to The Lor...         281   \n",
       "17   The Fellowship of the Ring (The Lord of the Ri...         368   \n",
       "26   Harry Potter and the Sorcerer's Stone (Harry P...         575   \n",
       "28      The Two Towers (The Lord of the Rings, Part 2)         260   \n",
       "39                               To Kill a Mockingbird         510   \n",
       "47                                   The Da Vinci Code         898   \n",
       "53                  The Five People You Meet in Heaven         430   \n",
       "55                              The Catcher in the Rye         449   \n",
       "62                           The Lovely Bones: A Novel        1295   \n",
       "63                                                1984         284   \n",
       "72                            Prodigal Summer: A Novel         253   \n",
       "73                                          Neverwhere         265   \n",
       "78                             The Secret Life of Bees         774   \n",
       "84   Stupid White Men ...and Other Sorry Excuses fo...         283   \n",
       "85   Tuesdays with Morrie: An Old Man, a Young Man,...         493   \n",
       "88                 The Red Tent (Bestselling Backlist)         723   \n",
       "89                The Hitchhiker's Guide to the Galaxy         268   \n",
       "98    Nickel and Dimed: On (Not) Getting By in America         335   \n",
       "100                                      Into the Wild         252   \n",
       "103                                     Fahrenheit 451         409   \n",
       "116                          Girl with a Pearl Earring         526   \n",
       "117                                          Outlander         283   \n",
       "123  Where the Heart Is (Oprah's Book Club (Paperba...         585   \n",
       "124                     Seabiscuit: An American Legend         275   \n",
       "126                                         Life of Pi         664   \n",
       "130                                     The Bean Trees         389   \n",
       "133  A Child Called \\It\\\": One Child's Courage to S...         265   \n",
       "135                                     ANGELA'S ASHES         279   \n",
       "137                                        Good in Bed         490   \n",
       "139  Fast Food Nation: The Dark Side of the All-Ame...         321   \n",
       "140                                      American Gods         302   \n",
       "141                                 Skipping Christmas         322   \n",
       "147  Left Behind: A Novel of the Earth's Last Days ...         318   \n",
       "149    The Golden Compass (His Dark Materials, Book 1)         336   \n",
       "157                                   The Color Purple         314   \n",
       "163                               Silence of the Lambs         256   \n",
       "166                                        About a Boy         262   \n",
       "173                  Seven Up (A Stephanie Plum Novel)         278   \n",
       "175  The Alchemist: A Fable About Following Your Dream         266   \n",
       "177  Hard Eight : A Stephanie Plum Novel (A Stephan...         269   \n",
       "182                       Suzanne's Diary for Nicholas         457   \n",
       "186                                  Lord of the Flies         259   \n",
       ...
       "\n",
       "     Avg-Rating             Book-Author  \\\n",
       "0      5.852804           J. K. Rowling   \n",
       "3      5.824289           J. K. Rowling   \n",
       "5      5.737410           J. K. Rowling   \n",
       "9      5.501441           J. K. Rowling   \n",
       "13     5.183453           J. K. Rowling   \n",
       "16     5.007117          J.R.R. TOLKIEN   \n",
       "17     4.948370          J.R.R. TOLKIEN   \n",
       "26     4.895652           J. K. Rowling   \n",
       "28     4.880769          J.R.R. TOLKIEN   \n",
       "39     4.700000              Harper Lee   \n",
       "47     4.642539               Dan Brown   \n",
       "53     4.551163             Mitch Albom   \n",
       "55     4.545657           J.D. Salinger   \n",
       "62     4.468726            Alice Sebold   \n",
       "63     4.454225           George Orwell   \n",
       "72     4.450593      Barbara Kingsolver   \n",
       "73     4.449057             Neil Gaiman   \n",
       "78     4.447028           Sue Monk Kidd   \n",
       "84     4.356890           Michael Moore   \n",
       "85     4.354970             MITCH ALBOM   \n",
       "88     4.334716           Anita Diamant   \n",
       "89     4.328358           Douglas Adams   \n",
       "98     4.289552      Barbara Ehrenreich   \n",
       "100    4.273810            Jon Krakauer   \n",
       "103    4.264059            Ray Bradbury   \n",
       "116    4.218631         Tracy Chevalier   \n",
       "117    4.173145          DIANA GABALDON   \n",
       "123    4.105983            Billie Letts   \n",
       "124    4.098182       LAURA HILLENBRAND   \n",
       "126    4.088855             Yann Martel   \n",
       "130    4.087404      Barbara Kingsolver   \n",
       "133    4.086792             Dave Pelzer   \n",
       "135    4.075269           Frank McCourt   \n",
       "137    4.055102         Jennifer Weiner   \n",
       "139    4.037383          Eric Schlosser   \n",
       "140    4.006623             Neil Gaiman   \n",
       "141    4.006211            JOHN GRISHAM   \n",
       "147    4.003145              Tim Lahaye   \n",
       "149    4.000000          PHILIP PULLMAN   \n",
       "157    3.964968            Alice Walker   \n",
       "163    3.960938           Thomas Harris   \n",
       "166    3.900763             Nick Hornby   \n",
       "173    3.888489         Janet Evanovich   \n",
       "175    3.875940            Paulo Coelho   \n",
       "177    3.825279         Janet Evanovich   \n",
       "182    3.820569         James Patterson   \n",
       "186    3.818533  William Gerald Golding   \n",
       "192    3.796610             John Irving   \n",
       "194    3.777409               ANNE RICE   \n",
       "195    3.772472             Janet Fitch   \n",
       "\n",
       "                                           Image-URL-M  \n",
       ...
       "72   http://images.amazon.com/images/P/0060959037.0...  \n",
       "73   http://images.amazon.com/images/P/0380789019.0...  \n",
       "78   http://images.amazon.com/images/P/0142001740.0...  \n",
       ...
       "147  http://images.amazon.com/images/P/0842329129.0...  \n",
       "149  http://images.amazon.com/images/P/037582345X.0...  \n",
   ...
   "source": [
    "popular_df = popular_df.merge(books,on = 'Book-Title').drop_duplicates('Book-Title')[['Book-Title','Num-Rating','Avg-Rating','Book-Author','Image-URL-M']]\n",
    "popular_df"
   ]
  },
  {
   "cell_type": "code",
   "execution_count": 16,
   "id": "e26bd494-2a27-4b19-bf00-9ce0d4b5c365",
   "metadata": {},
   "outputs": [
    {
     "data": {
  ...
  {
   "cell_type": "markdown",
   "id": "40694b0e-81b4-4504-80c1-f3a0d5e7210e",
   "metadata": {},
   "source": [
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 17,
   "id": "fb8acaec-b5f9-46ed-ac43-eb53b7d6b7fa",
   "metadata": {},
   "outputs": [],
   "source": [
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 18,
   "id": "98f67b9f-1629-4e87-a497-076db91bfc81",
   "metadata": {},
   "outputs": [],
   "source": [
    "filter_rating = book_rating[book_rating['User-ID'].isin(user_rating)]"
   ]
  },
  {
   "cell_type": "code",
   "execution_count": 19,
   "id": "da6fbf68-c89b-4e41-b615-b3014f8d1d64",
   "metadata": {},
   "outputs": [],
   "source": [
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 20,
   "id": "1355889b-4e45-4c75-823c-bf4f38b562f4",
   "metadata": {},
   "outputs": [],
   "source": [
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 21,
   "id": "28f9e63e-9022-4453-9a09-9822231fa61b",
   "metadata": {},
   "outputs": [
    {
     "data": {
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 22,
   "id": "958dc439-6c59-4a3a-8dcc-a4880f524f05",
   "metadata": {},
   "outputs": [],
   "source": [
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 23,
   "id": "a07c22d3-0c96-4812-a3e6-4f021600c794",
   "metadata": {},
   "outputs": [],
   "source": [
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 24,
   "id": "f112d0d5-5512-4558-b911-3cfcf7ff8c47",
   "metadata": {},
   "outputs": [
    {
     "data": {
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 25,
   "id": "9560774b-7447-4746-b930-2cc4e751d7f8",
   "metadata": {},
   "outputs": [],
   "source": [
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 26,
   "id": "5d63dd99-e9ec-4e7a-9985-1a17ffe105c9",
   "metadata": {},
   "outputs": [],
   "source": [
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 27,
   "id": "95984b14-07d8-4750-ad22-57597e36eac1",
   "metadata": {},
   "outputs": [
    {
     "data": {
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 40,
   "id": "ae93d378-b18f-4f09-8fc2-243f0e071e81",
   "metadata": {},
   "outputs": [],
   "source": [
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 41,
   "id": "1d9d9d81-b5eb-4803-9cb9-71e30cecde28",
   "metadata": {},
   "outputs": [
    {
     "name": "stdout",
  ...
  },
  {
   ...
   "id": "12ecb6cc-0bd8-43a8-ab69-08066d49df1b",
   "metadata": {},
   "outputs": [],
   "source": []
  }
